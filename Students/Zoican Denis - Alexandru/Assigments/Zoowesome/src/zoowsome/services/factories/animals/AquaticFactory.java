...
public class AquaticFactory extends SpeciesFactory {
	...
	public Animal getAnimal(String type) throws Exception {
		...
		if (Constants.Animals.Aquatics.GOLDFISH.equals(type)) {
			return new Goldfish(depth[r1],water[r2],"Goldfish",0,1.2,0.007); 
		} else if (Constants.Animals.Aquatics.CATFISH.equals(type)) {
			return new Catfish(depth[r1],water[r2],"Catfish",0,3.2,0.003); 
		} else if (Constants.Animals.Aquatics.CLOWNFISH.equals(type)){
			return new Clownfish(depth[r1],water[r2],"Clownfish",0,2.2,0.02); 
		} else {
